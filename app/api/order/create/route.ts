// app/api/orders/create/route.ts - Fixed to use cartItems
    ...
    return await dbServer.transaction(async (tx) => {
      ...
      const [newOrder] = await tx
        ...
        .values({
          ...
          paymentStatus:
            orderData.payment.method === "cash_delivery" ? "pending" : "unpaid",
      ...
      // Create order items - FIXED: Now using cartItems instead of items
