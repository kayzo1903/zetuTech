...
export const productSchema = z.object({
  ...
  images: z.instanceof(File).array().min(1, "At least one image is required").max(5, "Maximum 5 images allowed"),
  ...
  isFeatured: z.boolean().default(false), // Add this field
}).refine((data) => {
...
// Schema for updating products - allows empty images array
//failed to extend so copied and modified
