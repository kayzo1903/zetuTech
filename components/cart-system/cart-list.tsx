...
export default function CartList() {
  const { items, summary, updateQuantity, removeItem, clearCart, isLoading } =
    useCartStore();
  ...
  const openDeleteDialog = (cartItemId: string, productName: string) => {
    setDeleteDialog({
      open: true,
      itemId: cartItemId,
  ...
  const handleRemoveItem = async () => {
    ...
    try {
      ...
      toast.success(`${deleteDialog.itemName} removed from cart`);
    } catch (error) {
      console.error(error);
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm sm:text-base">
              ...
              • {summary.totalUniqueItems} unique products
            </p>
          </div>
          <Button
            variant="outline"
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start gap-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            openDeleteDialog(item.id, item.product.name)
                          }
                            ...
                            {item.product.hasDiscount ? (
                              <>
                                ...
                                <span className="text-xs bg-green-100 text-green-800 px-1.5 py-0.5 rounded-full">
                                  ...
                                  {Math.round(
                                    (1 -
                                      item.price / item.product.originalPrice) *
                                      100
                                  )}
                                  %
                                </span>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6 sticky top-4">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <Button
                  variant="ghost"
                  className="w-full text-gray-600 text-sm sm:text-base py-2 sm:py-3"
                >
            ...
            <div className="mt-4 sm:mt-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6 hidden sm:block">
              ...
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 text-center py-2 sm:py-4">
                <p>
                  Based on your cart items, we&apos;ll show recommendations here
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove &quot;{deleteDialog.itemName}
              &quot; from your shopping cart? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              This will remove {summary.totalItems}{" "}
              {summary.totalItems === 1 ? "item" : "items"} and cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
