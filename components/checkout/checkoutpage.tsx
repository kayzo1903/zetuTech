...
import { CheckoutData, ContactStepProps } from '@/lib/types/checkout';
...
export default function CheckoutPage() {
  ...
  const updateCheckoutData = (step: keyof CheckoutData, data: ContactStepProps ) => {
      ...
      case 1:
        return (
          <ContactStep
            ...
            onUpdate={(data) => updateCheckoutData('contact', data)}
            onNext={nextStep}
          />
        );
      case 2:
        return (
          <DeliveryStep
            ...
            onUpdate={(data) => updateCheckoutData('delivery', data)}
            onNext={nextStep}
            onBack={prevStep}
          />
        );
      case 3:
        return (
          <AddressStep
            ...
            onUpdate={(data) => updateCheckoutData('address', data)}
            onNext={nextStep}
            onBack={prevStep}
          />
        );
 ...
 // app/checkout/page.tsx - Update handleOrderConfirmation
