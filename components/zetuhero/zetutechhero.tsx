  ...
  p-8 md:p-12 grid grid-cols-1 md:grid-cols-2 gap-6 items-center transition-colors duration-300"
      >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 mt-4">
            <Badge className="bg-green-100 text-green-700 dark:bg-green-800 dark:text-green-200">
              Free delivery over 500,000 Tsh
            </Badge>
        ...
        <div className="hidden md:block">
          <div className="relative w-full h-64 rounded-xl overflow-hidden shadow-xl transition-colors duration-300">
            {/* Background Image */}
            <Image
              src="https://images.unsplash.com/photo-1587614382346-4ec70e388b28?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-gray-900/20 to-gray-900/40 dark:from-slate-900/30 dark:to-slate-900/50" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {TOP_CATEGORIES.map((c: Category) => (
            <Link key={c.id} href={c.link} className="block">
              <Card className="hover:shadow-lg p-0 transition-shadow group cursor-pointer overflow-hidden">
      ...
      <div className="mt-8">
        ...
        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
          {TOP_PRODUCT_TYPES.map((t: ProductType) => (
            <Link key={t.id} href={t.link} className="block">
              <Card className="relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-transform h-48">
      ...
      {/* PROMOTION STRIP */}
      <div className="mt-8">
        <Link href="/products?type=accessories">
